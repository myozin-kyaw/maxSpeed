            ...
            <div class="card">
              <div class="card-header d-flex bd-highlight mb-3">
                ...
                <div class="ms-auto p-2 bd-highlight">
                    <a href="/review/create" style="float:right;" class="btn btn-success">Create</a>
                </div>
              </div>
              @if (session('uploaded'))
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                      ...
                      <td>
                        <div class="form-row">
                            <a style="height:40px; margin-right:10px;" href="/review/{{$review->id}}/edit" class="btn btn-warning">Edit</a>
